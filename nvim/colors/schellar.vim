...
call s:HL('Constant', s:palette.grey0, s:palette.bg, 'italic')
...
call s:HL('Statement', s:palette.fg, s:palette.bg, 'none')
...
call s:HL('Directory', s:palette.fg, s:palette.bg, 'none')
...
call s:HL('Question', s:palette.fg, s:palette.bg, 'none')
...
call s:HL('TabLineSel', s:palette.fg, s:palette.bg, 'none')
"  TabLineSel      tab pages line, active tab page label

call s:HL('Title', s:palette.fg, s:palette.bg, 'none')
